...
import Domain.RunningAndJumpingCharacter;
...
public class Window extends Application implements Runnable{
    ...
    private RunningAndJumpingCharacter rjc;
    ...
    private void initComponents(Stage primaryStage) {
        try {
            ...
            this.rjc = new RunningAndJumpingCharacter(-50, 500, 0);
            this.rjc.start();            
    ...
    private void draw(GraphicsContext gc){
        ...
        gc.drawImage(this.rjc.getImage(), this.rjc.getX(), this.rjc.getY());
    }
